# Mock spaces library for local execution - MUST BE FIRST
import sys
from unittest.mock import MagicMock

# Create a mock spaces module with common decorators
spaces_mock = MagicMock()
spaces_mock.GPU = lambda *args, **kwargs: lambda func: func  # Mock decorator that does nothing
